################ SEER C-index and IBS: Plot from final dataset ################
...
df <- readRDS("results/SEER_CIndex.rds")
...
P3
 ...
 ggsave(
   filename = "results/figures/SEER_CIndex.pdf",
   plot = P3,
   width = 4.55,
   height = 4.6,
   units = "in",
 ...
 df <- readRDS("results/SEER_IBS.rds")
 df <- format_prediction_results(df)
 ...
 ggsave(
   filename = "results/figures/SEER_IBS.pdf",
   plot = P3,
   width = 4.6,
   height = 4.6,
   units = "in",
